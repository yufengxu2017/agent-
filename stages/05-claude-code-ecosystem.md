...
> 看 [`resources/mcp-skills-catalog.md`](../resources/mcp-skills-catalog.md)——按 15 個分類整理 65+ 個常用 MCP server / Skill，每個都附 stars / license / 適合誰。下表保留的是「**寫自己 MCP server 時的 reference**」性質的官方 server / SDK。
